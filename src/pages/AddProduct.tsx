      ...
      <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            ...
            {categories?.length === 0 && (
              <p className="text-sm text-red-500 mt-2">يرجى إضافة صنف أولاً من صفحة الأصناف.</p>
            )}
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-mono"
                placeholder="أدخل الباركود يدوياً أو استخدم الكاميرا"
              />
              <button 
                onClick={startScanner}
                className="bg-gray-100 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-200 transition flex items-center gap-2 font-medium"
              >
                <Camera size={20} />
                مسح
              </button>
            ...
            {isScanning && (
              <div className="mt-4 border rounded-lg overflow-hidden bg-gray-50 p-4">
                ...
                <button 
                  onClick={stopScanner}
                  className="w-full mt-4 bg-red-100 text-red-600 py-3 rounded-lg font-medium hover:bg-red-200 transition flex items-center justify-center gap-2"
                >
                  <X size={20} />
                  إلغاء المسح
                </button>
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-6 p-4 border border-gray-200 rounded-lg bg-gray-50">
              {image ? (
                ...
                <div className="w-24 h-24 bg-white rounded-lg border flex items-center justify-center text-gray-400 shadow-sm">
                  <ImageIcon size={32} />
                </div>
              )}
              <div className="flex flex-col gap-2">
                ...
                {image && (
                  <button onClick={() => setImage('')} className="text-red-500 hover:text-red-700 text-sm font-medium">
                    إزالة الصورة
                  </button>
                )}
              </div>
        ...
        <div className="flex gap-4 pt-8 mt-8 border-t border-gray-100">
          ...
          <button 
            onClick={() => navigate(-1)}
            className="bg-gray-100 text-gray-800 px-8 py-4 rounded-lg hover:bg-gray-200 transition text-lg font-medium"
          >
            إلغاء
          </button>
        </div>
